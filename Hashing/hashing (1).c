...
//     bool added = false ;
//     int hash_key = hash_function(data);
...
//             {
//                 current_pointer->frequency = current_pointer->frequency +1 ;
//                 added = true;
//                 done = SUCCESS;
//             }
//             else 
...
// Corrected the typo in the struct tag from "heash_node_tag" to "hash_node_tag"
typedef struct hash_node_tag {
    int data;
    int frequency;
